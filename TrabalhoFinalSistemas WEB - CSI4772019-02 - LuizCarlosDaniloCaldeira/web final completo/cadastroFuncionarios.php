        ...
        <div class="card-home">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-8">
                  <form action="./db/funcionarios/create.php" method="post" autocomplete="off">
                    <!-- email -->
                    <div class="form-group">
                      <input name="nome" type="text" class="form-control" required autofocus placeholder="Nome">
                    </div>
                ...
                <div class="col-3">
                  <table class="table table-bordeless table-light">
                    ...
                    <tbody>
                      <?php include_once './db/funcionarios/read.php'; ?>
                    </tbody>
