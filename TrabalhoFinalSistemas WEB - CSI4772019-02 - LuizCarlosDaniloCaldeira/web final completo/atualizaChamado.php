...
<?php
  ...
  $querySelect = $link->query("SELECT * FROM chamados c WHERE id = '$id'");

  while ($registros = $querySelect->fetch_assoc()) {
    $descricao = $registros['descricao'];
    $classe = $registros['classe'];
    $responsavel = $registros['id_responsavel'];
    $funcionario = $registros['id_funcionario'];
  }
?>
        ...
        <div class="card-home">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-8">
                  <form action="./db/chamados/update.php" method="post">
                    <!-- descricao -->
                    <div class="form-group">
                      <input name="descricao" value="<?php echo $descricao ?>"  type="text" class="form-control" required placeholder="Descreva o problema requisitado: ">
                    </div>
                    ...
                    <div class="form-group"required>
                      <select name="id_responsavel" class="form-control">
                        <option disabled selected value="0">Informa o responsavel pela tarefa: </option>
                        <?php
                          include_once './db/conexao.php';
